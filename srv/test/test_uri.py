...
def test_parse_git():
    ...
    uri = lsp.Uri.parse('git:/home/user/samples/bluetooth/mesh/light/prj.conf?%7B%22path%22%3A%22%2Fhome%2Fuser%2Fsamples%2Fbluetooth%2Fmesh%2Flight%2Fprj.conf%22%2C%22ref%22%3A%22~%22%7D')
