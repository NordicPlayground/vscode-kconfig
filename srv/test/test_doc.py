...
def test_disk_access():
    ...
    doc.open()
    assert doc.readline() == 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam in elit arcu. Nunc vitae facilisis mauris. Ut\n'
    assert doc.readline() == 'venenatis euismod lacinia. Nullam nibh felis, scelerisque id dapibus nec, elementum nec velit. Vestibulum vel metus\n'
